...
class Evaluator(object):
    ...
    def eval(self):
        ...
        for i, (image, target, filename) in enumerate(self.val_loader):
            ...
            datapath_512 = '/home/pzn/pzncode/non-local/awesome-semantic-segmentation-pytorch/runs/mat_result_512/' + filename_mat
            print(datapath_512)
            ...
            print('This is:', filename_mat)
            datapath_3 = '/home/pzn/pzncode/non-local/awesome-semantic-segmentation-pytorch/runs/mat_result_3/' + filename_mat
            print(datapath_3)
