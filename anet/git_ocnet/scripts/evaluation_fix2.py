...
class Evaluator(object):
    ...
    def eval(self):
        self.metric.reset()
        image_pre_path = '../datasets/evaluation/new0824/result_image_20200824_deep_512_hks_RGB_XY_100_121_new/'
        image_gt_path = '../datasets/evaluation/new0824/SegmentationClass_test/'
