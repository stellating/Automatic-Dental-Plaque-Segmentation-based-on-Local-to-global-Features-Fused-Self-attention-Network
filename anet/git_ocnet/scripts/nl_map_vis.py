...
if __name__ == '__main__':
    vis_nl_map(img_path='./raw_image/2018_000102.jpg', nl_map_path='nl_map_1.npy', vis_size=(700, 700))
    vis_nl_map(img_path='./raw_image/2018_000102.jpg', nl_map_path='nl_map_2.npy', vis_size=(700, 700))
